...
class ReadingPositionDaoTest {
    ...
    @Test
    fun insertThenGetByContentIdReturnsTheStoredPosition() = runTest {
    ...
    @Test
    fun getByContentIdReturnsNullWhenNoPositionStored() = runTest {
        val dao = database.readingPositionDao()
    ...
    @Test
    fun upsertReplacesThePositionForTheSameContent() = runTest {
        val dao = database.readingPositionDao()
    ...
    @Test
    fun separateContentItemsKeepIndependentPositions() = runTest {
        val dao = database.readingPositionDao()
