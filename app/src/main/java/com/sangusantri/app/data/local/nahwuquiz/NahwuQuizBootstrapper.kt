...
sealed interface NahwuQuizBootstrapOutcome {
    ...
    data class Imported(val packageCount: Int) : NahwuQuizBootstrapOutcome

    data class Rejected(val reason: String) : NahwuQuizBootstrapOutcome
}
 ...
 */
class NahwuQuizBootstrapper @Inject constructor(
    ...
    suspend fun bootstrapIfNeeded(): NahwuQuizBootstrapOutcome = withContext(Dispatchers.IO) {
    ...
    private fun readBank(): NahwuQuizBankDto? = runCatching {
