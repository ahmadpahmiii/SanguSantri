...
fun NahwuQuizPackageEntity.toDomain(questionCount: Int): NahwuQuizPackage = NahwuQuizPackage(
    id = id,
    title = title,
...
fun NahwuQuizPackageSummaryRow.toDomain(): NahwuQuizPackage = NahwuQuizPackage(
    id = id,
    title = title,
    description = description,
    order = order,
...
fun NahwuQuizQuestionEntity.toDomain(): NahwuQuizQuestion = NahwuQuizQuestion(
    id = id,
    packageId = packageId,
    order = order,
    stem = stem,
...
fun NahwuQuizAttemptEntity.toDomain(): NahwuQuizAttempt = NahwuQuizAttempt(
    id = id,
    packageId = packageId,
