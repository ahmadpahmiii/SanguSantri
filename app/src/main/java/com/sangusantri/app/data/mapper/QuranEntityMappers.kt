...
fun QuranSurahDto.toEntity(): QuranSurahEntity = QuranSurahEntity(
    number = id,
    latinName = nama,
    arabicName = arabic,
    meaning = arti,
...
fun QuranAyatDto.toEntity(): QuranVerseEntity = QuranVerseEntity(
    surahNumber = surah,
    ayatNumber = ayat,
    remoteId = id,
    juz = juz,
...
fun QuranTafsirDto.toEntity(cachedAtEpochMillis: Long): QuranTafsirEntity = QuranTafsirEntity(
    remoteAyatId = id,
    ringkas = teks,
    tahlili = tahlili,
...
fun QuranSurahEntity.toDomain(): QuranSurah = QuranSurah(
    number = number,
    latinName = latinName,
...
fun QuranVerseEntity.toDomain(): QuranVerse = QuranVerse(
...
fun QuranTafsirEntity.toDomain(): QuranTafsir = QuranTafsir(
...
fun QuranReadingStateEntity.toDomain(): QuranReadingState = QuranReadingState(
    surahNumber = surahNumber,
    ayatNumber = ayatNumber,
    page = page,
...
fun QuranReadingSessionEntity.toDomain(): QuranReadingSession = QuranReadingSession(
    id = id,
    surahNumber = surahNumber,
    startAyat = startAyat,
    endAyat = endAyat,
