...
sealed interface HijriCalendarUiAction {
    data class SelectDate(val date: LocalDate) : HijriCalendarUiAction
    ...
    data class SelectFilter(val filter: HijriCalendarAgendaFilter) : HijriCalendarUiAction

    data object OpenSourceSheet : HijriCalendarUiAction

    data object DismissSourceSheet : HijriCalendarUiAction

    data class ShowEventDetail(val eventId: String) : HijriCalendarUiAction
