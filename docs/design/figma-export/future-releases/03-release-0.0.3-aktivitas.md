...
No prior frame exists for this screen (`docs/design/FIGMA_HANDOFF.md`'s own
"Known incomplete Figma areas" note — confirmed, not contradicted, by this
pass). Built new from `docs/reviews/figma-product-alignment.md` decision K
...
Every frame in this section gets a small Figma annotation (not visible
